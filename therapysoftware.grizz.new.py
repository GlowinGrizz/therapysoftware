...
class TherapistGameUI:
    ...
    def start_session(self, intermediate_screen):
        ...
        self.response_output = scrolledtext.ScrolledText(session_window, wrap=tk.WORD, width=40, height=5, state='disabled', font=('Arial', 12))
        self.response_output.pack(pady=10)

        self.generate_button = ttk.Button(session_window, text="Tell the therapist", command=self.generate_ai_response, style='TButton')
    ...
    def generate_ai_response(self):
        ...
        # Check for pre-determined responses
        predetermined_response = self.get_predetermined_response(user_input)
        if predetermined_response:
            response = predetermined_response
        else:
            # If no pre-determined response, generate AI response
            response = self.generate_snarky_response(user_input)
    ...
    def get_predetermined_response(self, user_input):
        ...
        'I\'m feeling ambitious': 'Yo mama is the epitome of ambition',
        'I need a vacation': 'Yo mama is your dream vacation planner',
        'I\'m feeling overwhelmed': 'Yo mama handles everything with ease',
        'I\'m feeling proud': 'Yo mama is proud of your achievements',
        'I\'m feeling curious': 'Yo mama knows all the answers',
        'I\'m feeling adventurous': 'Yo mama loves adventure',
        'I want to make new friends': 'Yo mama is the friendliest person',
        'I\'m feeling creative': 'Yo mama is a creative genius',
        ...
        'I\'m feeling rebellious': 'Yo mama knows when to break the rules',
        'I want to learn photography': 'Yo mama captures every moment',
        'I\'m feeling philosophical': 'Yo mama has profound wisdom',
        'I want to learn to paint': 'Yo mama is a master artist',
        'I\'m feeling spontaneous': 'Yo mama loves spontaneous adventures',
        'I want to be more positive': 'Yo mama radiates positivity',
        'I\'m feeling sleepy': 'Yo mama never gets tired',
        ...
        'I\'m feeling inspired': 'Yo mama is an endless source of inspiration',
        ...
        'I feel so clumsy': 'Yo mama is always graceful',
        'I am feeling bipolar': 'So is Kanye',
        'I am feeling swaggy': 'Yo mama said swag is out dated',
        'sup': 'Hard dicks and airplanes',
        'Do you know joe': 'You talm bout Joe Mama?',
        'Forgive me father for I have sinned': 'I\'m Yo Mama but youre forgiven maybe',
        'suck my dick': 'you kiss yo mama with that mouth',
        'fuck you': 'Yo Mama said this ain\'t Alabama',
        'I wanna dye my hair': 'Gingers don\'t have souls',
        'Grizz is a bitch': 'Respectfully FUCK YOU',
        'Copernicus1n is gay': 'Is that a challenge',
        'Mtn Dew sucks': 'You\'re wrong on a million levels -coper',
        'I\'m horny': 'Yo Mama slays hoes left and right',
        'I\'m a furry': 'Yo Mama makes men howl',
        'I like men': 'So does Yo Mama',
        'I think I like this girl': 'Mama says if you can make her giggle you can make her jiggle ;)',
        'I wanna be a rapper': 'Yo Mama LOVES rappers ;)',
        'I feel like a loser': 'Yo Mama says losing is highly subjective, in this game We call life the only loss is death. if you are breathing, if you are feeling, if you are emotional, if you are activley doing anything, one must not feel that they have lost. Life is a game and it is never over until it\'s over. keep dreaming',
      # Add more responses as needed...
        }
        return responses.get(user_input)
    
    def generate_snarky_response(self, user_input):
        ...
        # Generate response without displaying the prefix message
